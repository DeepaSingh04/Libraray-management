...
function EditBook() {
  ...
  const handleSubmit = (e) => {
    ...
    editBookMutation.mutate(validationResult.data);
  };
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <h3 className="text-lg font-medium leading-6 text-gray-900">Edit Book</h3>
        ...
        <div className="flex justify-end">
          ...
          >
            {editBookMutation.isLoading ? 'Saving...' : 'Save Changes'}
          </button>
        </div>
        ...
        {getFieldError('submit') && (
          <div className="mt-4 bg-red-50 p-4 rounded-md">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-red-800">Error updating book</h3>
                <div className="mt-2 text-sm text-red-700">
